...
function cg_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'cg_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cg-front-page) .entry-title,
...
.colors-custom .cg-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cg-front-page .panel-content .recent-posts article,
...
.colors-custom.cg-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'cg_custom_colors_css', $css, $hue, $saturation );
}
